...
// ─── CIPHER LoRa packet protocol ───────────────────────────────────────────
// Self-contained wire format for CIPHER mesh nodes: AES-256-EAX encryption,
// AEAD authentication, per-packet nonce, and a compact broadcast header.
...
// ─── Direction ────────────────────────────────────────────────────────────
#define DIR_BROADCAST     0xFF   // peer-to-peer broadcast (only mode CIPHER uses)

// ─── Firmware / mode type ─────────────────────────────────────────────────
#define FW_PING           0x00
#define FW_CIPHER         0x20   // CIPHER mesh chat node
